...
# Insights
Technology is the highest revenue-generating category, indicating strong customer demand and premium pricing potential.
Average delivery time is 3.96 days, showing moderate operational efficiency with room for optimization.
Revenue is a bit concentrated among the Top 10 customers, highlighting dependency on high-value buyers.
Indiana is the most profitable state ($18,382.94), while Ohio is generating significant losses (-$16,959), showing geographic imbalance.
Sales experienced steady growth from 2014 to 2017, reflecting scalable and expanding business model.
The West region leads in profitability, indicating stronger market performance and operational efficiency.
The Consumer segment generates the highest profit, outperforming Corporate and Home Office segments.
Overall:
